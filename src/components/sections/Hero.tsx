...
const Hero: React.FC = () => {
  ...
  const terminalContent = <>
      ...
      <div className="text-primary">{`/buy ETH 0.5 limit 3400 scale 5 end 3300`}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-2">
              ...
              <AnimatedText text="Telegram Bot Trading Platform" className="text-xl sm:text-2xl md:text-3xl font-medium text-foreground/90" delay={600} tag="h2" />
            </div>
            
            <AnimatedText text="Elysium provides professional traders with an advanced Telegram Bot for executing complex strategies on Hyperliquid exchange from anywhere." className="text-foreground/70 text-base sm:text-lg max-w-xl" delay={900} tag="p" />
